...
IMAGE_UPLOAD_MAX_BYTES = int(os.getenv("IMAGE_UPLOAD_MAX_BYTES", str(8 * 1024 * 1024)))
IMAGE_UPLOAD_MAX_REQUEST_BYTES = int(os.getenv("IMAGE_UPLOAD_MAX_REQUEST_BYTES", str(20 * 1024 * 1024)))
IMAGE_UPLOAD_MAX_PIXELS = int(os.getenv("IMAGE_UPLOAD_MAX_PIXELS", str(12 * 1024 * 1024)))
IMAGE_UPLOAD_MAX_WIDTH = int(os.getenv("IMAGE_UPLOAD_MAX_WIDTH", "4096"))
IMAGE_UPLOAD_MAX_HEIGHT = int(os.getenv("IMAGE_UPLOAD_MAX_HEIGHT", "4096"))
IMAGE_UPLOAD_BURST_LIMIT = int(os.getenv("IMAGE_UPLOAD_BURST_LIMIT", "3"))
IMAGE_UPLOAD_BURST_WINDOW_SECONDS = int(os.getenv("IMAGE_UPLOAD_BURST_WINDOW_SECONDS", "60"))
IMAGE_UPLOAD_MIN_INTERVAL_SECONDS = int(os.getenv("IMAGE_UPLOAD_MIN_INTERVAL_SECONDS", "10"))
IMAGE_UPLOAD_HOURLY_LIMIT = int(os.getenv("IMAGE_UPLOAD_HOURLY_LIMIT", "30"))
IMAGE_UPLOAD_DAILY_LIMIT = int(os.getenv("IMAGE_UPLOAD_DAILY_LIMIT", "100"))
IMAGE_UPLOAD_IP_HOURLY_LIMIT = int(os.getenv("IMAGE_UPLOAD_IP_HOURLY_LIMIT", "120"))
IMAGE_UPLOAD_IP_DAILY_LIMIT = int(os.getenv("IMAGE_UPLOAD_IP_DAILY_LIMIT", "400"))
IMAGE_UPLOAD_IP_HOURLY_BYTES = int(os.getenv("IMAGE_UPLOAD_IP_HOURLY_BYTES", str(128 * 1024 * 1024)))
IMAGE_UPLOAD_IP_DAILY_BYTES = int(os.getenv("IMAGE_UPLOAD_IP_DAILY_BYTES", str(512 * 1024 * 1024)))
MOMENT_IMAGE_THUMBNAIL_MAX_SIDE = int(os.getenv("MOMENT_IMAGE_THUMBNAIL_MAX_SIDE", "480"))
MOMENT_IMAGE_THUMBNAIL_MAX_BYTES = int(os.getenv("MOMENT_IMAGE_THUMBNAIL_MAX_BYTES", str(180 * 1024)))
MOMENT_IMAGE_REJECTED_RETENTION_DAYS = int(os.getenv("MOMENT_IMAGE_REJECTED_RETENTION_DAYS", "30"))
IMAGE_MODERATION_PROVIDER = os.getenv("IMAGE_MODERATION_PROVIDER", "disabled").strip().lower() or "disabled"
ALIYUN_IMAGE_MODERATION = {
    "ENABLED": _bool_env("ALIYUN_IMAGE_MODERATION_ENABLED", default=False),
    "ACCESS_KEY_ID": os.getenv("ALIYUN_IMAGE_MODERATION_ACCESS_KEY_ID", "").strip(),
    "ACCESS_KEY_SECRET": os.getenv("ALIYUN_IMAGE_MODERATION_ACCESS_KEY_SECRET", "").strip(),
    "ENDPOINTS": _csv_env(
        "ALIYUN_IMAGE_MODERATION_ENDPOINTS",
        "green.cn-shanghai.aliyuncs.com,green.cn-beijing.aliyuncs.com",
    ),
    "TIMEOUT_SECONDS": int(os.getenv("ALIYUN_IMAGE_MODERATION_TIMEOUT_SECONDS", "15")),
}
MEDIA_HOTLINK_PROTECTION = _bool_env("MEDIA_HOTLINK_PROTECTION", default=True)
MEDIA_HOTLINK_PROTECTED_PREFIXES = _csv_env("MEDIA_HOTLINK_PROTECTED_PREFIXES", "moments,moments-thumbs,avatars")
MEDIA_HOTLINK_ALLOWED_HOSTS = _csv_env("MEDIA_HOTLINK_ALLOWED_HOSTS", "")
