...
ARG VITE_SECONDARY_CAPTCHA_ENABLED=0
ARG VITE_SECONDARY_CAPTCHA_PROVIDER=geetest
ARG VITE_GEETEST_CAPTCHA_ID=

ENV VITE_TURNSTILE_SITE_KEY=${VITE_TURNSTILE_SITE_KEY} \
    VITE_SECONDARY_CAPTCHA_ENABLED=${VITE_SECONDARY_CAPTCHA_ENABLED} \
    VITE_SECONDARY_CAPTCHA_PROVIDER=${VITE_SECONDARY_CAPTCHA_PROVIDER} \
    VITE_GEETEST_CAPTCHA_ID=${VITE_GEETEST_CAPTCHA_ID}
